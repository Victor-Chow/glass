...
class PosongProvider {
    static async validateApiKey(key) {
        ...
        try {
            const response = await fetch('http://api.openai.rnd.huawei.com/v1/models', {
            ...
            console.error(`[PosongProvider] Network error during key validation:`, error);
  ...
  return {
    streamChat: async (messages) => {
      const fetchUrl = usePortkey 
        ...
        : 'http://api.openai.rnd.huawei.com/v1/chat/completions';
